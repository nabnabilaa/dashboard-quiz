...
export function SlideVisuals({ slide }: SlideVisualsProps) {
    switch (slide.visualType) {
                ...
                <div className="flex flex-col items-center justify-center gap-4 md:gap-6 w-full h-full">
                    <div className="flex flex-wrap justify-center gap-3 md:gap-4">
                        <div className="flex flex-col items-center gap-2 p-3 md:p-4 bg-orange-50 border border-orange-200 rounded-xl w-24 md:w-32 shadow-sm">
                            ...
                            <span className="text-[9px] md:text-[10px] text-center text-slate-500">Walls & Pillars</span>
                        </div>
                        <div className="flex flex-col items-center gap-2 p-3 md:p-4 bg-pink-50 border border-pink-200 rounded-xl w-24 md:w-32 shadow-sm">
                            ...
                            <span className="text-[9px] md:text-[10px] text-center text-slate-500">Colors & Decor</span>
                        </div>
                    </div>
                    <div className="flex flex-col items-center gap-2 p-3 md:p-4 bg-yellow-50 border border-yellow-200 rounded-xl w-24 md:w-32 animate-pulse shadow-sm">
                        ...
                        <span className="text-[9px] md:text-[10px] text-center text-slate-500">Electricity</span>
                    </div>
                </div>
            );
            ...
            return (
                <div className="w-full max-w-[280px] bg-gray-100 rounded-lg overflow-hidden border-2 border-gray-600 shadow-2xl flex flex-col font-mono text-[10px]">
                    ...
                    <div className="bg-blue-100 p-2 relative border-b-2 border-blue-400 border-dashed">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center bg-blue-500/20 backdrop-blur-[1px] font-bold text-blue-700 text-[9px]">NOT VISIBLE</div>
                    </div>
                    <div className="bg-white p-4 h-28 md:h-32 relative">
                        ...
                        <h1 className="text-base md:text-lg font-bold text-black mb-1">Hello World!</h1>
                        <button className="bg-blue-600 text-white px-2 py-1 rounded text-[10px]">Click Me</button>
                        <div className="absolute bottom-2 right-2 text-[8px] md:text-[9px] text-green-700 font-bold bg-green-100 px-1 border border-green-500">USER AREA</div>
                    </div>
                </div>
            );
            ...
            return (
                <div className="flex flex-col gap-4 w-full px-4 md:px-6">
                    ...
                    <div className="bg-red-50 border border-red-200 p-4 rounded-xl relative shadow-sm">
                        <div className="absolute -top-2.5 -left-2 bg-red-600 text-white px-2 py-0.5 text-[10px] rounded-lg font-bold shadow-sm">WITHOUT TAG</div>
                        <div className="text-red-900/70 text-xs font-mono leading-tight mt-2 break-words">
                            This Heading This Paragraph This Button All stuck in one messy line.
                        </div>
                    </div>
                    ...
                    <div className="bg-green-50 border border-green-200 p-4 rounded-xl relative shadow-sm">
                        <div className="absolute -top-2.5 -left-2 bg-green-600 text-white px-2 py-0.5 text-[10px] rounded-lg font-bold shadow-sm">WITH TAG</div>
                        <div className="text-slate-700 text-xs font-sans mt-2">
                            <h1 className="font-bold text-lg text-slate-900 mb-1">This is a Heading</h1>
                            <p className="mb-2 text-slate-600">This is a neat paragraph.</p>
                            <button className="bg-slate-800 text-white px-3 py-1 rounded-md text-[10px] shadow-sm">Button</button>
                        </div>
                    </div>
                </div>
            );
            ...
            return (
                <div className="flex flex-col gap-2 font-mono text-sm w-full px-4 md:px-8">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-orange-400 text-[10px] md:text-xs whitespace-nowrap">Opening</span>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-orange-400 text-[10px] md:text-xs whitespace-nowrap">Closing (/)</span>
                    </div>
                </div>
            );
            ...
            return (
                <div className="bs-scope bg-white p-4 md:p-6 text-black w-full h-full flex flex-col justify-center gap-2 rounded-xl shadow-lg relative">
                    ...
                    <div className="border-b pb-1 mb-1 border-gray-200">
                        ...
                        <span className="text-[8px] md:text-[9px] text-gray-400 font-mono">&lt;h1&gt; Main Topic &lt;/h1&gt;</span>
                    </div>
                    <div className="pl-4 border-l-2 border-gray-300">
                        <h3 className="m-0 text-lg md:text-xl font-bold text-gray-700">Heading 3</h3>
                        <span className="text-[8px] md:text-[9px] text-gray-400 font-mono">&lt;h3&gt; Sub-chapter &lt;/h3&gt;</span>
                    </div>
                    <div className="pl-8 border-l-2 border-gray-200">
                        <h6 className="m-0 text-xs font-bold text-gray-500 uppercase">Heading 6</h6>
                        <span className="text-[8px] md:text-[9px] text-gray-400 font-mono">&lt;h6&gt; Small Label &lt;/h6&gt;</span>
                    </div>
                </div>
            );
                ...
                <div className="bs-scope bg-white p-4 md:p-6 text-black w-full rounded-xl shadow-lg">
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-3 p-2 bg-gray-50 rounded">
                            ...
                            <span>Paragraph with spacing</span>
                        </div>
                    </div>
                </div>
            );
        ...
        case 'div_box':
            return (
                <div className="relative w-40 h-40 md:w-48 md:h-48 border-4 border-dashed border-purple-400 rounded-xl flex items-center justify-center bg-purple-50 group">
                    <span className="absolute -top-3 bg-purple-600 text-white px-2 py-0.5 text-[10px] font-bold rounded shadow-sm">DIV (Container)</span>
                    ...
                    <div className="absolute bottom-2 text-[8px] md:text-[9px] text-purple-700 text-center px-2 md:px-4 font-medium">Wraps elements as a group</div>
                </div>
            );
            ...
            return (
                <div className="flex flex-col items-center justify-center gap-6 h-full">
                    ...
                    <div className="flex items-center gap-2 bg-red-50 px-3 py-2 rounded-lg border border-red-100 text-red-600 mt-2">
                        ...
                        <span className="text-[10px] font-medium">If src is wrong = Broken Image</span>
                    </div>
                </div>
            );
                ...
                <div className="bs-scope bg-white p-4 md:p-6 rounded-xl shadow-lg w-full">
                    <div className="space-y-4">
                        <div className="p-3 bg-blue-50 rounded-lg border border-blue-200">
                            ...
                            <a href="#" className="text-blue-600 underline">Link to Google</a>
                        </div>
                        <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                            ...
                            <span className="text-[10px] text-gray-500 block mt-1"># = Stays in place</span>
                        </div>
                    </div>
                </div>
            );
            ...
            return (
                <div className="flex flex-col gap-3 md:gap-4 w-full px-4 md:px-6">
                    <div className="p-3 border border-slate-300 rounded bg-slate-100 scale-95">
                        <div className="text-[9px] text-slate-500 mb-1 font-bold">Without Bootstrap (Manual CSS)</div>
                        ...
                        <button style={{ background: 'blue', color: 'white', padding: '5px 10px', borderRadius: '4px', fontSize: '10px' }}>Button</button>
                    </div>
                    ...
                    <div className="p-3 md:p-4 border-2 border-blue-500 rounded bg-blue-50 shadow-lg shadow-blue-500/20 relative">
                        ...
                        <div className="text-[10px] text-blue-800 mb-2 mt-1 font-medium">Simply call Class:</div>
                        ...
                        <button className="bg-blue-600 text-white px-4 py-2 rounded shadow hover:bg-blue-500 transition-all text-xs font-bold">Cool Button</button>
                    </div>
                </div>
            );
                ...
                <div className="w-full max-w-[280px] bg-white rounded-lg shadow-lg border border-indigo-100 overflow-hidden">
                    ...
                    <div className="p-4">
                        <div className="grid grid-cols-3 gap-px bg-indigo-200 border border-indigo-200 rounded text-[10px]">
                            {/* Header */}
                            <div className="bg-indigo-100 p-2 font-bold text-indigo-800">Day</div>
                            <div className="bg-indigo-100 p-2 font-bold text-indigo-800">Time</div>
                            <div className="bg-indigo-100 p-2 font-bold text-indigo-800">Subject</div>

                            {/* Row 1 */}
                            <div className="bg-white p-2 text-slate-600">Monday</div>
                            <div className="bg-white p-2 text-slate-600">08:00</div>
                            <div className="bg-white p-2 text-slate-600">Math</div>

                            {/* Row 2 */}
                            <div className="bg-white p-2 text-slate-600">Tuesday</div>
                            <div className="bg-white p-2 text-slate-600">09:00</div>
                            <div className="bg-white p-2 text-slate-600">Science</div>
                        </div>
        ...
        case 'input_form':
            return (
                <div className="w-full max-w-[280px] bg-white rounded-xl shadow-lg border border-slate-200 p-6 flex flex-col gap-4">
                    <div className="text-sm font-bold text-slate-800 border-b pb-2">Registration Form</div>
                    <div className="space-y-3">
                        <div className="space-y-1">
                            <label className="text-[10px] uppercase font-bold text-slate-400">Name (Text)</label>
        ...
        default:
            return <div className="text-center text-gray-500">Material Visualization</div>;
    }
}
