    ...
    return (
        <div className="bg-white border border-slate-200 rounded-2xl w-full max-w-4xl shadow-lg mx-auto overflow-hidden animate-fade-in">
            <div className="bg-gradient-to-r from-[#F5A623] to-[#E09000] p-6 text-center relative overflow-hidden">
                ...
                <p className="text-orange-50 text-sm relative z-10 mt-1">Panduan Singkat Git & GitHub</p>
            </div>
            ...
            <div className="p-6 md:p-8">
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-6">
                        <h3 className="text-[#E09000] font-bold text-xs uppercase tracking-widest border-b border-orange-200 pb-2">Alur Dasar</h3>
                        ...
                        <div className="flex gap-4 items-start group">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                                    Tempat kamu menulis kode. Folder proyek di komputermu.
                                </p>
                        ...
                        <div className="flex gap-4 items-start group">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                                    Area persiapan. Pilih file mana yang mau disimpan.
                                </p>
                        ...
                        <div className="flex gap-4 items-start group">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                                    Mencatat sejarah perubahan secara permanen di komputermu.
                                </p>
                                <code className="inline-block mt-2 bg-slate-100 px-2 py-1 rounded text-[10px] font-mono text-green-600 border border-slate-200">git commit -m "pesan"</code>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-4 items-start group">
                            ...
                            <div>
                                <h4 className="font-bold text-slate-800 text-sm">Branching (Cabang)</h4>
                                <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                                    Membuat jalur atau versi terpisah agar kode utama aman.
                                </p>
                                <code className="inline-block mt-2 bg-slate-100 px-2 py-1 rounded text-[10px] font-mono text-pink-600 border border-slate-200">git branch fitur-baru</code>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-4 items-start group">
                            ...
                            <div>
                                <h4 className="font-bold text-slate-800 text-sm">Merging (Gabung)</h4>
                                <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                                    Menggabungkan kode dari cabang lain ke cabang utama.
                                </p>
                                <code className="inline-block mt-2 bg-slate-100 px-2 py-1 rounded text-[10px] font-mono text-purple-600 border border-slate-200">git merge fitur-baru</code>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-4 items-start group">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500 mt-1 leading-relaxed">
                                    Menyimpan kodemu di internet (Cloud) agar bisa kolaborasi.
                                </p>
