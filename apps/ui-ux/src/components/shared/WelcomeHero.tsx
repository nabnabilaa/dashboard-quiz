...
import { LanguageToggle } from '@belajar/i18n/LanguageToggle';
...
const copy = {
    en: {
        ...
        welcome: 'Welcome to',
        brand: 'Maxy Learning! 🚀',
        statLabel: '20 Modules · 20 Quiz · 15 Fixers',
    },
    id: {
        badge: 'Platform Belajar Interaktif',
        welcome: 'Selamat datang di',
        brand: 'Maxy Learning! 🚀',
        statLabel: '20 Modul · 20 Kuis · 15 Fixer',
    },
} as const;
                ...
                <div className="hidden flex-shrink-0 md:block">
                    <div className="flex h-28 w-36 items-center justify-center rounded-2xl border border-white/20 bg-white/15 backdrop-blur-sm">
                        <div className="space-y-0.5 text-center">
                            <div className="text-2xl font-extrabold leading-none">UI/UX</div>
                            <div className="text-lg font-extrabold leading-none">Mastery</div>
                            <div className="px-2 pt-1.5 text-[10px] font-medium leading-snug text-white/80">{t.statLabel}</div>
                        </div>
                    </div>
                </div>
            </div>
