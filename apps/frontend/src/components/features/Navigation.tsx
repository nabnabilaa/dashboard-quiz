...
import { Book, GraduationCap, PenTool, Palette, ArrowLeft } from 'lucide-react';
...
export const Navigation: React.FC<NavigationProps> = ({ phase, setPhase }) => {
    ...
    const navItems = [
        ...
        { id: 'intro', label: t.intro, icon: Book },
        { id: 'quiz', label: t.quiz, icon: GraduationCap },
        { id: 'workshop', label: t.workshop, icon: PenTool },
        { id: 'builder', label: t.builder, icon: Palette },
    ];
